...
export const TopInfo = (params) => {
  ...
  if (top === 'overview') {
    ...
    return <p>Please select from each tab to see More information</p>
  } else if (top === 'ui') {
    return (
      <>
        <p>
    ...
    return (
      <>
        ...
        <ul>
          <li>Estimated Probability greater or equal to {modelInfo[model].threshold}.</li>
          <li>Shock Index greater or equal to 1.</li>
          {model !== 'model5' && <li>ABC score greater or equal to 2.</li>}
        </ul>
      </>
    )
  }
